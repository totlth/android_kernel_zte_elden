 ...
 * Shared IMEM used instead of ZTE's log memory
 */
#ifdef ZTE_SYNC_REMOTEFS_FOR_SUSPEND_RESTORE
...
#endif /* ZTE_SYNC_REMOTEFS_FOR_SUSPEND_RESTORE */
...
extern void save_tcpAfterResume(void);
extern void dump_tcpAfterResume(void);
