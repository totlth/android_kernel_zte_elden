...
static struct clk_lookup msm_clocks_8960_v1[] __initdata = {
	...
	CLK_LOOKUP("core_clk",	gsbi11_uart_clk.c,	"msm_serial_hs.1"),
	...
	CLK_LOOKUP("iface_clk",		gsbi11_p_clk.c,		"msm_serial_hs.1"),
	...
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-001e"),
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0010"),
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-002d"),
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"7-001f"),
#endif
