...
static int mipi_lcd_on(struct platform_device *pdev)
{
	...
	switch(LcdPanleID){
		...
		case (u32)LCD_PANEL_4P0_HX8363_IVO_CMI:
				mipi_dsi_cmds_tx(mfd, &lead_tx_buf, hx8363_cmi_display_on_cmds,ARRAY_SIZE(hx8363_cmi_display_on_cmds));
...
#endif
//	if((LcdPanleID==LCD_PANEL_4P0_HIMAX8369_LEAD_HANNSTAR)|| 
//			(LcdPanleID==LCD_PANEL_4P0_HIMAX8369_TIANMA_TN))
		lcdinit_backlight_delay = 110;
