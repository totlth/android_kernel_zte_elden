...
#include "msm.h"
#include "msm_ispif.h"
#define SENSOR_NAME "s5k5caga"
#define PLATFORM_DRIVER_NAME "msm_camera_s5k5caga"
#define s5k5caga_obj s5k5caga_##obj
...
DEFINE_MUTEX(s5k5caga_mut);
static struct msm_sensor_ctrl_t s5k5caga_s_ctrl;


static struct msm_camera_i2c_reg_conf s5k5caga_prev_settings[] = {
...
static struct msm_camera_i2c_reg_conf s5k5caga_snap_settings[] ={
...
static struct msm_camera_i2c_reg_conf s5k5caga_reset_settings[] = {
	{0xFCFC, 0xD000},
	{0x0010, 0x0001},
	{0x1030, 0x0000},
	{0x0014, 0x0001},
...
static struct msm_camera_i2c_reg_conf s5k5caga_recommend_settings1[] ={
...
{0x0F12, 0x00D8},   //TVAR_ash_GAsalpha[16] //D50  
{0x0F12, 0x00f8},   //TVAR_ash_GAsalpha[17] //
{0x0F12, 0x00f8},   //TVAR_ash_GAsalpha[18] //
{0x0F12, 0x0110},   //TVAR_ash_GAsalpha[19] //

{0x0F12, 0x00E0},   //TVAR_ash_GAsalpha[20] //D65  
{0x0F12, 0x0100},   //TVAR_ash_GAsalpha[21] //
{0x0F12, 0x0100},   //TVAR_ash_GAsalpha[22] //
{0x0F12, 0x0118},   //TVAR_ash_GAsalpha[23] //

{0x0F12, 0x00E0},   //TVAR_ash_GAsalpha[24] //D75  
{0x0F12, 0x0100},   //TVAR_ash_GAsalpha[25] //
{0x0F12, 0x0100},   //TVAR_ash_GAsalpha[26] //
{0x0F12, 0x0118},   //TVAR_ash_GAsalpha[27] //

{0x0F12, 0x00E8},	//TVAR_ash_GAS OutdoorAlpha[0] //
{0x0F12, 0x0100},   //TVAR_ash_GAS OutdoorAlpha[1] //
{0x0F12, 0x0100},   //TVAR_ash_GAS OutdoorAlpha[2] //
{0x0F12, 0x0120},   //TVAR_ash_GAS OutdoorAlpha[3] //
...
{0x002A, 0x347C},
{0x0F12, 0x020D},    //01D9	//TVAR_ash_pGAS[0] //
{0x0F12, 0x01C8},    //019D   //TVAR_ash_pGAS[1] //  
{0x0F12, 0x0187},    //015C   //TVAR_ash_pGAS[2] //  
{0x0F12, 0x014E},    //0125   //TVAR_ash_pGAS[3] //  
{0x0F12, 0x0123},    //00FE   //TVAR_ash_pGAS[4] //  
{0x0F12, 0x0103},    //00E5   //TVAR_ash_pGAS[5] //  
{0x0F12, 0x00ED},    //00DA   //TVAR_ash_pGAS[6] //  
{0x0F12, 0x00E7},    //00E5   //TVAR_ash_pGAS[7] //  
{0x0F12, 0x00F1},    //0100   //TVAR_ash_pGAS[8] //  
{0x0F12, 0x010B},    //012D   //TVAR_ash_pGAS[9] //  
{0x0F12, 0x0133},    //016B   //TVAR_ash_pGAS[10] // 
{0x0F12, 0x016A},    //01B3   //TVAR_ash_pGAS[11] // 
{0x0F12, 0x01A6},    //01F2   //TVAR_ash_pGAS[12] // 
{0x0F12, 0x01D2},    //01A7   //TVAR_ash_pGAS[13] // 
{0x0F12, 0x0188},    //0165   //TVAR_ash_pGAS[14] // 
{0x0F12, 0x0140},    //011E   //TVAR_ash_pGAS[15] // 
{0x0F12, 0x0105},    //00E3   //TVAR_ash_pGAS[16] // 
{0x0F12, 0x00D7},    //00B6   //TVAR_ash_pGAS[17] // 
{0x0F12, 0x00B6},    //009C   //TVAR_ash_pGAS[18] // 
{0x0F12, 0x00A0},    //0092   //TVAR_ash_pGAS[19] // 
{0x0F12, 0x009C},    //009D   //TVAR_ash_pGAS[20] // 
{0x0F12, 0x00A8},    //00BB   //TVAR_ash_pGAS[21] // 
{0x0F12, 0x00CA},    //00F0   //TVAR_ash_pGAS[22] // 
{0x0F12, 0x00F5},    //0133   //TVAR_ash_pGAS[23] // 
{0x0F12, 0x012E},    //0182   //TVAR_ash_pGAS[24] // 
{0x0F12, 0x0165},    //01CD   //TVAR_ash_pGAS[25] // 
{0x0F12, 0x0197},    //0170   //TVAR_ash_pGAS[26] // 
{0x0F12, 0x014E},    //012A   //TVAR_ash_pGAS[27] // 
{0x0F12, 0x0102},    //00DC   //TVAR_ash_pGAS[28] // 
{0x0F12, 0x00C3},    //009A   //TVAR_ash_pGAS[29] // 
{0x0F12, 0x0091},    //006E   //TVAR_ash_pGAS[30] // 
{0x0F12, 0x0070},    //0053   //TVAR_ash_pGAS[31] // 
{0x0F12, 0x005B},    //004A   //TVAR_ash_pGAS[32] // 
{0x0F12, 0x005A},    //0055   //TVAR_ash_pGAS[33] // 
{0x0F12, 0x0069},    //0076   //TVAR_ash_pGAS[34] // 
{0x0F12, 0x0090},    //00AC   //TVAR_ash_pGAS[35] // 
{0x0F12, 0x00C0},    //00F5   //TVAR_ash_pGAS[36] // 
{0x0F12, 0x0101},    //0147   //TVAR_ash_pGAS[37] // 
{0x0F12, 0x013B},    //0196   //TVAR_ash_pGAS[38] // 
{0x0F12, 0x015A},    //014C   //TVAR_ash_pGAS[39] // 
{0x0F12, 0x010F},    //0102   //TVAR_ash_pGAS[40] // 
{0x0F12, 0x00C2},    //00B1   //TVAR_ash_pGAS[41] // 
{0x0F12, 0x0082},    //006F   //TVAR_ash_pGAS[42] // 
{0x0F12, 0x0056},    //0041   //TVAR_ash_pGAS[43] // 
{0x0F12, 0x0036},    //0027   //TVAR_ash_pGAS[44] // 
{0x0F12, 0x0026},    //001F   //TVAR_ash_pGAS[45] // 
{0x0F12, 0x0025},    //002A   //TVAR_ash_pGAS[46] // 
{0x0F12, 0x0036},    //004B   //TVAR_ash_pGAS[47] // 
{0x0F12, 0x005E},    //0083   //TVAR_ash_pGAS[48] // 
{0x0F12, 0x0093},    //00CE   //TVAR_ash_pGAS[49] // 
{0x0F12, 0x00D2},    //0128   //TVAR_ash_pGAS[50] // 
{0x0F12, 0x0111},    //0177   //TVAR_ash_pGAS[51] // 
{0x0F12, 0x013D},    //0133   //TVAR_ash_pGAS[52] // 
{0x0F12, 0x00F2},    //00E6   //TVAR_ash_pGAS[53] // 
{0x0F12, 0x00A6},    //0094   //TVAR_ash_pGAS[54] // 
{0x0F12, 0x0064},    //0052   //TVAR_ash_pGAS[55] // 
{0x0F12, 0x0035},    //0025   //TVAR_ash_pGAS[56] // 
{0x0F12, 0x0017},    //000C   //TVAR_ash_pGAS[57] // 
{0x0F12, 0x0008},    //0004   //TVAR_ash_pGAS[58] // 
{0x0F12, 0x0009},    //0010   //TVAR_ash_pGAS[59] // 
{0x0F12, 0x001B},    //0030   //TVAR_ash_pGAS[60] // 
{0x0F12, 0x0040},    //0069   //TVAR_ash_pGAS[61] // 
{0x0F12, 0x0076},    //00B6   //TVAR_ash_pGAS[62] // 
{0x0F12, 0x00BC},    //0112   //TVAR_ash_pGAS[63] // 
{0x0F12, 0x00FC},    //0168   //TVAR_ash_pGAS[64] // 
{0x0F12, 0x0134},    //012F   //TVAR_ash_pGAS[65] // 
{0x0F12, 0x00E6},    //00E3   //TVAR_ash_pGAS[66] // 
{0x0F12, 0x0097},    //008E   //TVAR_ash_pGAS[67] // 
{0x0F12, 0x0058},    //004C   //TVAR_ash_pGAS[68] // 
{0x0F12, 0x0029},    //0020   //TVAR_ash_pGAS[69] // 
{0x0F12, 0x000D},    //0007   //TVAR_ash_pGAS[70] // 
...
{0x0F12, 0x0069},    //00B4   //TVAR_ash_pGAS[75] // 
{0x0F12, 0x00B7},    //0114   //TVAR_ash_pGAS[76] // 
{0x0F12, 0x00F9},    //016B   //TVAR_ash_pGAS[77] // 
{0x0F12, 0x0136},    //0138   //TVAR_ash_pGAS[78] // 
{0x0F12, 0x00E7},    //00EB   //TVAR_ash_pGAS[79] // 
{0x0F12, 0x009A},    //0099   //TVAR_ash_pGAS[80] // 
{0x0F12, 0x005C},    //0058   //TVAR_ash_pGAS[81] // 
{0x0F12, 0x002D},    //002B   //TVAR_ash_pGAS[82] // 
{0x0F12, 0x0012},    //0012   //TVAR_ash_pGAS[83] // 
{0x0F12, 0x0006},    //000B   //TVAR_ash_pGAS[84] // 
{0x0F12, 0x0008},    //0017   //TVAR_ash_pGAS[85] // 
{0x0F12, 0x0018},    //0039   //TVAR_ash_pGAS[86] // 
{0x0F12, 0x003B},    //0074   //TVAR_ash_pGAS[87] // 
{0x0F12, 0x0070},    //00C2   //TVAR_ash_pGAS[88] // 
{0x0F12, 0x00B7},    //0121   //TVAR_ash_pGAS[89] // 
{0x0F12, 0x00FB},    //0177   //TVAR_ash_pGAS[90] // 
{0x0F12, 0x014F},    //0158   //TVAR_ash_pGAS[91] // 
{0x0F12, 0x00FC},    //010C   //TVAR_ash_pGAS[92] // 
{0x0F12, 0x00AF},    //00BC   //TVAR_ash_pGAS[93] // 
{0x0F12, 0x0072},    //007B   //TVAR_ash_pGAS[94] // 
{0x0F12, 0x0044},    //004E   //TVAR_ash_pGAS[95] // 
{0x0F12, 0x0029},    //0034   //TVAR_ash_pGAS[96] // 
{0x0F12, 0x001A},    //002D   //TVAR_ash_pGAS[97] // 
{0x0F12, 0x001D},    //003B   //TVAR_ash_pGAS[98] // 
{0x0F12, 0x002D},    //005E   //TVAR_ash_pGAS[99] // 
{0x0F12, 0x0051},    //0099   //TVAR_ash_pGAS[100] //
{0x0F12, 0x0089},    //00E7   //TVAR_ash_pGAS[101] //
{0x0F12, 0x00CD},    //0145   //TVAR_ash_pGAS[102] //
{0x0F12, 0x010D},    //0197   //TVAR_ash_pGAS[103] //
{0x0F12, 0x016C},    //017E   //TVAR_ash_pGAS[104] //
{0x0F12, 0x0120},    //0138   //TVAR_ash_pGAS[105] //
{0x0F12, 0x00D3},    //00EB   //TVAR_ash_pGAS[106] //
{0x0F12, 0x0097},    //00AC   //TVAR_ash_pGAS[107] //
{0x0F12, 0x006B},    //0080   //TVAR_ash_pGAS[108] //
{0x0F12, 0x004C},    //0067   //TVAR_ash_pGAS[109] //
{0x0F12, 0x003B},    //0061   //TVAR_ash_pGAS[110] //
{0x0F12, 0x003D},    //006E   //TVAR_ash_pGAS[111] //
{0x0F12, 0x0052},    //0091   //TVAR_ash_pGAS[112] //
{0x0F12, 0x0078},    //00CA   //TVAR_ash_pGAS[113] //
{0x0F12, 0x00A8},    //0116   //TVAR_ash_pGAS[114] //
{0x0F12, 0x00EC},    //016E   //TVAR_ash_pGAS[115] //
{0x0F12, 0x012D},    //01C0   //TVAR_ash_pGAS[116] //
{0x0F12, 0x019F},    //01BB   //TVAR_ash_pGAS[117] //
{0x0F12, 0x014F},    //0177   //TVAR_ash_pGAS[118] //
{0x0F12, 0x0102},    //0131   //TVAR_ash_pGAS[119] //
{0x0F12, 0x00CC},    //00F7   //TVAR_ash_pGAS[120] //
{0x0F12, 0x00A1},    //00CE   //TVAR_ash_pGAS[121] //
{0x0F12, 0x0087},    //00B6   //TVAR_ash_pGAS[122] //
{0x0F12, 0x0074},    //00AF   //TVAR_ash_pGAS[123] //
{0x0F12, 0x0076},    //00BD   //TVAR_ash_pGAS[124] //
{0x0F12, 0x0087},    //00DF   //TVAR_ash_pGAS[125] //
{0x0F12, 0x00AB},    //0113   //TVAR_ash_pGAS[126] //
{0x0F12, 0x00DC},    //0156   //TVAR_ash_pGAS[127] //
{0x0F12, 0x0119},    //01AA   //TVAR_ash_pGAS[128] //
{0x0F12, 0x015A},    //01F7   //TVAR_ash_pGAS[129] //
{0x0F12, 0x01C8},    //01EF   //TVAR_ash_pGAS[130] //
{0x0F12, 0x0177},    //01B2   //TVAR_ash_pGAS[131] //
{0x0F12, 0x0138},    //0170   //TVAR_ash_pGAS[132] //
{0x0F12, 0x0107},    //013E   //TVAR_ash_pGAS[133] //
{0x0F12, 0x00E3},    //0119   //TVAR_ash_pGAS[134] //
{0x0F12, 0x00C7},    //0103   //TVAR_ash_pGAS[135] //
{0x0F12, 0x00B6},    //00FF   //TVAR_ash_pGAS[136] //
{0x0F12, 0x00B5},    //010D   //TVAR_ash_pGAS[137] //
{0x0F12, 0x00C3},    //012B   //TVAR_ash_pGAS[138] //
{0x0F12, 0x00E6},    //0158   //TVAR_ash_pGAS[139] //
{0x0F12, 0x010D},    //0194   //TVAR_ash_pGAS[140] //
{0x0F12, 0x014D},    //01DA   //TVAR_ash_pGAS[141] //
{0x0F12, 0x018C},    //0207   //TVAR_ash_pGAS[142] //
{0x0F12, 0x01A8},    //0198   //TVAR_ash_pGAS[143] //
{0x0F12, 0x0167},    //0156   //TVAR_ash_pGAS[144] //
{0x0F12, 0x0130},    //011D   //TVAR_ash_pGAS[145] //
{0x0F12, 0x0103},    //00EF   //TVAR_ash_pGAS[146] //
{0x0F12, 0x00DF},    //00C9   //TVAR_ash_pGAS[147] //
{0x0F12, 0x00C4},    //00B2   //TVAR_ash_pGAS[148] //
{0x0F12, 0x00B4},    //00A9   //TVAR_ash_pGAS[149] //
{0x0F12, 0x00B0},    //00B1   //TVAR_ash_pGAS[150] //
{0x0F12, 0x00B7},    //00C5   //TVAR_ash_pGAS[151] //
{0x0F12, 0x00C9},    //00E7   //TVAR_ash_pGAS[152] //
{0x0F12, 0x00E5},    //0113   //TVAR_ash_pGAS[153] //
{0x0F12, 0x010E},    //0152   //TVAR_ash_pGAS[154] //
{0x0F12, 0x0144},    //018C   //TVAR_ash_pGAS[155] //
{0x0F12, 0x0173},    //016E   //TVAR_ash_pGAS[156] //
{0x0F12, 0x0131},    //0127   //TVAR_ash_pGAS[157] //
{0x0F12, 0x00F7},    //00E8   //TVAR_ash_pGAS[158] //
{0x0F12, 0x00C7},    //00B6   //TVAR_ash_pGAS[159] //
{0x0F12, 0x00A0},    //0090   //TVAR_ash_pGAS[160] //
{0x0F12, 0x0084},    //0078   //TVAR_ash_pGAS[161] //
{0x0F12, 0x0074},    //0070   //TVAR_ash_pGAS[162] //
{0x0F12, 0x0072},    //0078   //TVAR_ash_pGAS[163] //
{0x0F12, 0x007C},    //008F   //TVAR_ash_pGAS[164] //
{0x0F12, 0x0092},    //00B5   //TVAR_ash_pGAS[165] //
{0x0F12, 0x00B3},    //00E7   //TVAR_ash_pGAS[166] //
{0x0F12, 0x00DD},    //0126   //TVAR_ash_pGAS[167] //
{0x0F12, 0x010E},    //016C   //TVAR_ash_pGAS[168] //
{0x0F12, 0x0148},    //013D   //TVAR_ash_pGAS[169] //
{0x0F12, 0x0107},    //00F6   //TVAR_ash_pGAS[170] //
{0x0F12, 0x00C9},    //00B5   //TVAR_ash_pGAS[171] //
{0x0F12, 0x0096},    //0080   //TVAR_ash_pGAS[172] //
{0x0F12, 0x006D},    //0058   //TVAR_ash_pGAS[173] //
{0x0F12, 0x0051},    //0040   //TVAR_ash_pGAS[174] //
{0x0F12, 0x0044},    //0038   //TVAR_ash_pGAS[175] //
{0x0F12, 0x0042},    //0042   //TVAR_ash_pGAS[176] //
{0x0F12, 0x004E},    //005B   //TVAR_ash_pGAS[177] //
{0x0F12, 0x006A},    //0083   //TVAR_ash_pGAS[178] //
{0x0F12, 0x008E},    //00B9   //TVAR_ash_pGAS[179] //
{0x0F12, 0x00BE},    //00F9   //TVAR_ash_pGAS[180] //
{0x0F12, 0x00EE},    //0141   //TVAR_ash_pGAS[181] //
{0x0F12, 0x0114},    //011E   //TVAR_ash_pGAS[182] //
{0x0F12, 0x00D4},    //00D7   //TVAR_ash_pGAS[183] //
{0x0F12, 0x0098},    //0094   //TVAR_ash_pGAS[184] //
{0x0F12, 0x0063},    //005E   //TVAR_ash_pGAS[185] //
{0x0F12, 0x0040},    //0035   //TVAR_ash_pGAS[186] //
{0x0F12, 0x0025},    //001E   //TVAR_ash_pGAS[187] //
{0x0F12, 0x0018},    //0017   //TVAR_ash_pGAS[188] //
{0x0F12, 0x0019},    //0021   //TVAR_ash_pGAS[189] //
{0x0F12, 0x0027},    //003C   //TVAR_ash_pGAS[190] //
{0x0F12, 0x0045},    //0066   //TVAR_ash_pGAS[191] //
{0x0F12, 0x006C},    //009F   //TVAR_ash_pGAS[192] //
{0x0F12, 0x009D},    //00E2   //TVAR_ash_pGAS[193] //
{0x0F12, 0x00CE},    //012A   //TVAR_ash_pGAS[194] //
{0x0F12, 0x00FB},    //010A   //TVAR_ash_pGAS[195] //
{0x0F12, 0x00BA},    //00C0   //TVAR_ash_pGAS[196] //
{0x0F12, 0x007F},    //007B   //TVAR_ash_pGAS[197] //
{0x0F12, 0x004C},    //0045   //TVAR_ash_pGAS[198] //
{0x0F12, 0x0028},    //001F   //TVAR_ash_pGAS[199] //
{0x0F12, 0x000F},    //0008   //TVAR_ash_pGAS[200] //
{0x0F12, 0x0004},    //0002   //TVAR_ash_pGAS[201] //
{0x0F12, 0x0005},    //000C   //TVAR_ash_pGAS[202] //
{0x0F12, 0x0014},    //0027   //TVAR_ash_pGAS[203] //
{0x0F12, 0x002F},    //0052   //TVAR_ash_pGAS[204] //
{0x0F12, 0x0058},    //008C   //TVAR_ash_pGAS[205] //
{0x0F12, 0x008C},    //00D2   //TVAR_ash_pGAS[206] //
{0x0F12, 0x00C1},    //011E   //TVAR_ash_pGAS[207] //
{0x0F12, 0x00F3},    //0106   //TVAR_ash_pGAS[208] //
{0x0F12, 0x00B2},    //00BC   //TVAR_ash_pGAS[209] //
{0x0F12, 0x0075},    //0077   //TVAR_ash_pGAS[210] //
{0x0F12, 0x0043},    //0040   //TVAR_ash_pGAS[211] //
{0x0F12, 0x001F},    //001A   //TVAR_ash_pGAS[212] //
{0x0F12, 0x0008},    //0005   //TVAR_ash_pGAS[213] //
{0x0F12, 0x0000},    //0000   //TVAR_ash_pGAS[214] //
{0x0F12, 0x0003},    //000A   //TVAR_ash_pGAS[215] //
{0x0F12, 0x000F},    //0026   //TVAR_ash_pGAS[216] //
{0x0F12, 0x0029},    //0052   //TVAR_ash_pGAS[217] //
{0x0F12, 0x0052},    //008D   //TVAR_ash_pGAS[218] //
{0x0F12, 0x008B},    //00D5   //TVAR_ash_pGAS[219] //
{0x0F12, 0x00BF},    //0121   //TVAR_ash_pGAS[220] //
{0x0F12, 0x00F4},    //010A   //TVAR_ash_pGAS[221] //
{0x0F12, 0x00B3},    //00C1   //TVAR_ash_pGAS[222] //
{0x0F12, 0x0077},    //007E   //TVAR_ash_pGAS[223] //
{0x0F12, 0x0048},    //0049   //TVAR_ash_pGAS[224] //
{0x0F12, 0x0022},    //0023   //TVAR_ash_pGAS[225] //
{0x0F12, 0x000C},    //000E   //TVAR_ash_pGAS[226] //
{0x0F12, 0x0006},    //0009   //TVAR_ash_pGAS[227] //
{0x0F12, 0x000A},    //0015   //TVAR_ash_pGAS[228] //
{0x0F12, 0x0015},    //0031   //TVAR_ash_pGAS[229] //
{0x0F12, 0x002E},    //005D   //TVAR_ash_pGAS[230] //
{0x0F12, 0x0059},    //0097   //TVAR_ash_pGAS[231] //
{0x0F12, 0x008C},    //00DF   //TVAR_ash_pGAS[232] //
{0x0F12, 0x00C2},    //0129   //TVAR_ash_pGAS[233] //
{0x0F12, 0x0108},    //0121   //TVAR_ash_pGAS[234] //
{0x0F12, 0x00C4},    //00DA   //TVAR_ash_pGAS[235] //
{0x0F12, 0x0087},    //009A   //TVAR_ash_pGAS[236] //
{0x0F12, 0x0058},    //0065   //TVAR_ash_pGAS[237] //
{0x0F12, 0x0032},    //0040   //TVAR_ash_pGAS[238] //
{0x0F12, 0x001F},    //002B   //TVAR_ash_pGAS[239] //
{0x0F12, 0x0015},    //0026   //TVAR_ash_pGAS[240] //
{0x0F12, 0x0019},    //0031   //TVAR_ash_pGAS[241] //
{0x0F12, 0x0026},    //004E   //TVAR_ash_pGAS[242] //
{0x0F12, 0x003E},    //007C   //TVAR_ash_pGAS[243] //
{0x0F12, 0x006B},    //00B6   //TVAR_ash_pGAS[244] //
{0x0F12, 0x009D},    //00FB   //TVAR_ash_pGAS[245] //
{0x0F12, 0x00D2},    //0143   //TVAR_ash_pGAS[246] //
{0x0F12, 0x0122},    //0140   //TVAR_ash_pGAS[247] //
{0x0F12, 0x00E1},    //00FB   //TVAR_ash_pGAS[248] //
{0x0F12, 0x00A5},    //00BD   //TVAR_ash_pGAS[249] //
{0x0F12, 0x0073},    //008C   //TVAR_ash_pGAS[250] //
{0x0F12, 0x0053},    //0068   //TVAR_ash_pGAS[251] //
{0x0F12, 0x003B},    //0054   //TVAR_ash_pGAS[252] //
{0x0F12, 0x0031},    //004F   //TVAR_ash_pGAS[253] //
{0x0F12, 0x0034},    //005B   //TVAR_ash_pGAS[254] //
{0x0F12, 0x0042},    //0077   //TVAR_ash_pGAS[255] //
{0x0F12, 0x005E},    //00A2   //TVAR_ash_pGAS[256] //
{0x0F12, 0x0082},    //00DA   //TVAR_ash_pGAS[257] //
{0x0F12, 0x00B4},    //011C   //TVAR_ash_pGAS[258] //
{0x0F12, 0x00EA},    //0163   //TVAR_ash_pGAS[259] //
{0x0F12, 0x014A},    //0173   //TVAR_ash_pGAS[260] //
{0x0F12, 0x0104},    //012D   //TVAR_ash_pGAS[261] //
{0x0F12, 0x00C4},    //00F5   //TVAR_ash_pGAS[262] //
{0x0F12, 0x009B},    //00C6   //TVAR_ash_pGAS[263] //
{0x0F12, 0x0079},    //00A5   //TVAR_ash_pGAS[264] //
{0x0F12, 0x0068},    //0092   //TVAR_ash_pGAS[265] //
{0x0F12, 0x005C},    //008F   //TVAR_ash_pGAS[266] //
{0x0F12, 0x005F},    //009B   //TVAR_ash_pGAS[267] //
{0x0F12, 0x006C},    //00B5   //TVAR_ash_pGAS[268] //
{0x0F12, 0x0086},    //00DC   //TVAR_ash_pGAS[269] //
{0x0F12, 0x00A9},    //010C   //TVAR_ash_pGAS[270] //
{0x0F12, 0x00D5},    //014C   //TVAR_ash_pGAS[271] //
{0x0F12, 0x010C},    //0197   //TVAR_ash_pGAS[272] //
{0x0F12, 0x016B},    //019F   //TVAR_ash_pGAS[273] //
{0x0F12, 0x0125},    //015F   //TVAR_ash_pGAS[274] //
{0x0F12, 0x00F4},    //0128   //TVAR_ash_pGAS[275] //
{0x0F12, 0x00CC},    //00FF   //TVAR_ash_pGAS[276] //
{0x0F12, 0x00AE},    //00E1   //TVAR_ash_pGAS[277] //
{0x0F12, 0x0099},    //00D0   //TVAR_ash_pGAS[278] //
{0x0F12, 0x008E},    //00CF   //TVAR_ash_pGAS[279] //
{0x0F12, 0x0090},    //00DA   //TVAR_ash_pGAS[280] //
{0x0F12, 0x009C},    //00F4   //TVAR_ash_pGAS[281] //
{0x0F12, 0x00B6},    //0116   //TVAR_ash_pGAS[282] //
{0x0F12, 0x00D2},    //0142   //TVAR_ash_pGAS[283] //
{0x0F12, 0x0103},    //017A   //TVAR_ash_pGAS[284] //
{0x0F12, 0x0135},    //01A8   //TVAR_ash_pGAS[285] //
{0x0F12, 0x0198},    //0191   //TVAR_ash_pGAS[286] //
{0x0F12, 0x0154},    //0152   //TVAR_ash_pGAS[287] //
{0x0F12, 0x011D},    //0118   //TVAR_ash_pGAS[288] //
{0x0F12, 0x00F0},    //00EB   //TVAR_ash_pGAS[289] //
{0x0F12, 0x00D3},    //00C8   //TVAR_ash_pGAS[290] //
{0x0F12, 0x00BC},    //00B4   //TVAR_ash_pGAS[291] //
{0x0F12, 0x00B1},    //00AF   //TVAR_ash_pGAS[292] //
{0x0F12, 0x00B5},    //00BB   //TVAR_ash_pGAS[293] //
{0x0F12, 0x00C2},    //00D5   //TVAR_ash_pGAS[294] //
{0x0F12, 0x00D9},    //00FE   //TVAR_ash_pGAS[295] //
{0x0F12, 0x00FE},    //012E   //TVAR_ash_pGAS[296] //
{0x0F12, 0x012B},    //016E   //TVAR_ash_pGAS[297] //
{0x0F12, 0x016E},    //01AC   //TVAR_ash_pGAS[298] //
{0x0F12, 0x0164},    //0166   //TVAR_ash_pGAS[299] //
{0x0F12, 0x0121},    //0121   //TVAR_ash_pGAS[300] //
{0x0F12, 0x00E5},    //00E3   //TVAR_ash_pGAS[301] //
{0x0F12, 0x00B8},    //00B3   //TVAR_ash_pGAS[302] //
{0x0F12, 0x0096},    //008E   //TVAR_ash_pGAS[303] //
{0x0F12, 0x007D},    //0079   //TVAR_ash_pGAS[304] //
{0x0F12, 0x0071},    //0074   //TVAR_ash_pGAS[305] //
{0x0F12, 0x0075},    //0081   //TVAR_ash_pGAS[306] //
{0x0F12, 0x0083},    //009D   //TVAR_ash_pGAS[307] //
{0x0F12, 0x009E},    //00C7   //TVAR_ash_pGAS[308] //
{0x0F12, 0x00C5},    //00FF   //TVAR_ash_pGAS[309] //
{0x0F12, 0x00F6},    //013F   //TVAR_ash_pGAS[310] //
{0x0F12, 0x012B},    //0188   //TVAR_ash_pGAS[311] //
{0x0F12, 0x0138},    //0134   //TVAR_ash_pGAS[312] //
{0x0F12, 0x00F8},    //00F1   //TVAR_ash_pGAS[313] //
{0x0F12, 0x00BB},    //00B1   //TVAR_ash_pGAS[314] //
{0x0F12, 0x008A},    //007C   //TVAR_ash_pGAS[315] //
{0x0F12, 0x0065},    //0057   //TVAR_ash_pGAS[316] //
{0x0F12, 0x004E},    //0041   //TVAR_ash_pGAS[317] //
{0x0F12, 0x0042},    //003C   //TVAR_ash_pGAS[318] //
{0x0F12, 0x0044},    //0048   //TVAR_ash_pGAS[319] //
{0x0F12, 0x0055},    //0065   //TVAR_ash_pGAS[320] //
{0x0F12, 0x0074},    //0091   //TVAR_ash_pGAS[321] //
{0x0F12, 0x009B},    //00CA   //TVAR_ash_pGAS[322] //
{0x0F12, 0x00D0},    //010C   //TVAR_ash_pGAS[323] //
{0x0F12, 0x0104},    //0157   //TVAR_ash_pGAS[324] //
{0x0F12, 0x0109},    //0118   //TVAR_ash_pGAS[325] //
{0x0F12, 0x00C8},    //00D2   //TVAR_ash_pGAS[326] //
{0x0F12, 0x008D},    //0091   //TVAR_ash_pGAS[327] //
{0x0F12, 0x005D},    //005C   //TVAR_ash_pGAS[328] //
{0x0F12, 0x003C},    //0035   //TVAR_ash_pGAS[329] //
{0x0F12, 0x0023},    //001E   //TVAR_ash_pGAS[330] //
{0x0F12, 0x0019},    //0019   //TVAR_ash_pGAS[331] //
{0x0F12, 0x001B},    //0025   //TVAR_ash_pGAS[332] //
{0x0F12, 0x002C},    //0043   //TVAR_ash_pGAS[333] //
{0x0F12, 0x004C},    //0070   //TVAR_ash_pGAS[334] //
{0x0F12, 0x0076},    //00A9   //TVAR_ash_pGAS[335] //
{0x0F12, 0x00AA},    //00EE   //TVAR_ash_pGAS[336] //
{0x0F12, 0x00DE},    //0136   //TVAR_ash_pGAS[337] //
{0x0F12, 0x00F8},    //0105   //TVAR_ash_pGAS[338] //
{0x0F12, 0x00B9},    //00BD   //TVAR_ash_pGAS[339] //
{0x0F12, 0x007D},    //007B   //TVAR_ash_pGAS[340] //
{0x0F12, 0x004A},    //0046   //TVAR_ash_pGAS[341] //
{0x0F12, 0x0028},    //001F   //TVAR_ash_pGAS[342] //
{0x0F12, 0x000F},    //0009   //TVAR_ash_pGAS[343] //
{0x0F12, 0x0004},    //0003   //TVAR_ash_pGAS[344] //
{0x0F12, 0x0007},    //000E   //TVAR_ash_pGAS[345] //
{0x0F12, 0x0018},    //002B   //TVAR_ash_pGAS[346] //
{0x0F12, 0x0035},    //0057   //TVAR_ash_pGAS[347] //
{0x0F12, 0x005E},    //0091   //TVAR_ash_pGAS[348] //
{0x0F12, 0x0095},    //00D7   //TVAR_ash_pGAS[349] //
{0x0F12, 0x00C9},    //0121   //TVAR_ash_pGAS[350] //
{0x0F12, 0x00F5},    //0105   //TVAR_ash_pGAS[351] //
{0x0F12, 0x00B6},    //00BC   //TVAR_ash_pGAS[352] //
{0x0F12, 0x0078},    //0078   //TVAR_ash_pGAS[353] //
{0x0F12, 0x0047},    //0043   //TVAR_ash_pGAS[354] //
{0x0F12, 0x0021},    //001D   //TVAR_ash_pGAS[355] //
{0x0F12, 0x000A},    //0006   //TVAR_ash_pGAS[356] //
{0x0F12, 0x0000},    //0000   //TVAR_ash_pGAS[357] //
{0x0F12, 0x0004},    //000B   //TVAR_ash_pGAS[358] //
{0x0F12, 0x0011},    //0026   //TVAR_ash_pGAS[359] //
{0x0F12, 0x002B},    //0052   //TVAR_ash_pGAS[360] //
{0x0F12, 0x0054},    //008C   //TVAR_ash_pGAS[361] //
{0x0F12, 0x008F},    //00D3   //TVAR_ash_pGAS[362] //
{0x0F12, 0x00C4},    //011E   //TVAR_ash_pGAS[363] //
{0x0F12, 0x00FC},    //010D   //TVAR_ash_pGAS[364] //
{0x0F12, 0x00BE},    //00C5   //TVAR_ash_pGAS[365] //
{0x0F12, 0x0081},    //0083   //TVAR_ash_pGAS[366] //
{0x0F12, 0x004F},    //004E   //TVAR_ash_pGAS[367] //
{0x0F12, 0x0028},    //0027   //TVAR_ash_pGAS[368] //
{0x0F12, 0x000F},    //000F   //TVAR_ash_pGAS[369] //
{0x0F12, 0x0007},    //0008   //TVAR_ash_pGAS[370] //
{0x0F12, 0x0009},    //0012   //TVAR_ash_pGAS[371] //
{0x0F12, 0x0014},    //002E   //TVAR_ash_pGAS[372] //
{0x0F12, 0x002E},    //0059   //TVAR_ash_pGAS[373] //
{0x0F12, 0x0056},    //0091   //TVAR_ash_pGAS[374] //
{0x0F12, 0x008B},    //00D6   //TVAR_ash_pGAS[375] //
{0x0F12, 0x00C1},    //0120   //TVAR_ash_pGAS[376] //
{0x0F12, 0x0115},    //012A   //TVAR_ash_pGAS[377] //
{0x0F12, 0x00D4},    //00E2   //TVAR_ash_pGAS[378] //
{0x0F12, 0x0097},    //00A2   //TVAR_ash_pGAS[379] //
{0x0F12, 0x0064},    //006D   //TVAR_ash_pGAS[380] //
{0x0F12, 0x003C},    //0045   //TVAR_ash_pGAS[381] //
{0x0F12, 0x0024},    //002D   //TVAR_ash_pGAS[382] //
{0x0F12, 0x0018},    //0025   //TVAR_ash_pGAS[383] //
{0x0F12, 0x0018},    //002E   //TVAR_ash_pGAS[384] //
{0x0F12, 0x0025},    //0049   //TVAR_ash_pGAS[385] //
{0x0F12, 0x003B},    //0073   //TVAR_ash_pGAS[386] //
{0x0F12, 0x0065},    //00AA   //TVAR_ash_pGAS[387] //
{0x0F12, 0x0097},    //00EC   //TVAR_ash_pGAS[388] //
{0x0F12, 0x00CD},    //0135   //TVAR_ash_pGAS[389] //
{0x0F12, 0x0136},    //0149   //TVAR_ash_pGAS[390] //
{0x0F12, 0x00F3},    //0105   //TVAR_ash_pGAS[391] //
{0x0F12, 0x00B6},    //00C9   //TVAR_ash_pGAS[392] //
{0x0F12, 0x0083},    //0096   //TVAR_ash_pGAS[393] //
{0x0F12, 0x005E},    //006F   //TVAR_ash_pGAS[394] //
{0x0F12, 0x0042},    //0056   //TVAR_ash_pGAS[395] //
{0x0F12, 0x0032},    //004E   //TVAR_ash_pGAS[396] //
{0x0F12, 0x0033},    //0056   //TVAR_ash_pGAS[397] //
{0x0F12, 0x003F},    //006F   //TVAR_ash_pGAS[398] //
{0x0F12, 0x0059},    //0096   //TVAR_ash_pGAS[399] //
{0x0F12, 0x007A},    //00CA   //TVAR_ash_pGAS[400] //
{0x0F12, 0x00AA},    //0109   //TVAR_ash_pGAS[401] //
{0x0F12, 0x00DF},    //0153   //TVAR_ash_pGAS[402] //
{0x0F12, 0x015E},    //0181   //TVAR_ash_pGAS[403] //
{0x0F12, 0x0118},    //013B   //TVAR_ash_pGAS[404] //
{0x0F12, 0x00DA},    //0102   //TVAR_ash_pGAS[405] //
{0x0F12, 0x00AF},    //00D2   //TVAR_ash_pGAS[406] //
{0x0F12, 0x0089},    //00AE   //TVAR_ash_pGAS[407] //
{0x0F12, 0x0072},    //0096   //TVAR_ash_pGAS[408] //
{0x0F12, 0x0060},    //008D   //TVAR_ash_pGAS[409] //
{0x0F12, 0x005F},    //0094   //TVAR_ash_pGAS[410] //
{0x0F12, 0x0069},    //00AA   //TVAR_ash_pGAS[411] //
{0x0F12, 0x0080},    //00CC   //TVAR_ash_pGAS[412] //
{0x0F12, 0x009F},    //00F8   //TVAR_ash_pGAS[413] //
{0x0F12, 0x00C9},    //0135   //TVAR_ash_pGAS[414] //
{0x0F12, 0x00FE},    //0183   //TVAR_ash_pGAS[415] //
{0x0F12, 0x0183},    //01B0   //TVAR_ash_pGAS[416] //
{0x0F12, 0x013B},    //016F   //TVAR_ash_pGAS[417] //
{0x0F12, 0x010C},    //0139   //TVAR_ash_pGAS[418] //
{0x0F12, 0x00E3},    //010E   //TVAR_ash_pGAS[419] //
{0x0F12, 0x00C4},    //00ED   //TVAR_ash_pGAS[420] //
{0x0F12, 0x00A8},    //00D6   //TVAR_ash_pGAS[421] //
{0x0F12, 0x0096},    //00CD   //TVAR_ash_pGAS[422] //
{0x0F12, 0x0091},    //00D3   //TVAR_ash_pGAS[423] //
{0x0F12, 0x0099},    //00E8   //TVAR_ash_pGAS[424] //
{0x0F12, 0x00AD},    //0106   //TVAR_ash_pGAS[425] //
{0x0F12, 0x00C7},    //012D   //TVAR_ash_pGAS[426] //
{0x0F12, 0x00F0},    //0163   //TVAR_ash_pGAS[427] //
{0x0F12, 0x0126},    //0195   //TVAR_ash_pGAS[428] //
{0x0F12, 0x0164},    //0146   //TVAR_ash_pGAS[429] //
{0x0F12, 0x0124},    //011B   //TVAR_ash_pGAS[430] //
{0x0F12, 0x00F4},    //00EC   //TVAR_ash_pGAS[431] //
{0x0F12, 0x00CD},    //00C6   //TVAR_ash_pGAS[432] //
{0x0F12, 0x00B5},    //00AD   //TVAR_ash_pGAS[433] //
{0x0F12, 0x00A2},    //009F   //TVAR_ash_pGAS[434] //
{0x0F12, 0x0099},    //009C   //TVAR_ash_pGAS[435] //
{0x0F12, 0x009B},    //00A6   //TVAR_ash_pGAS[436] //
{0x0F12, 0x00A7},    //00BC   //TVAR_ash_pGAS[437] //
{0x0F12, 0x00BA},    //00DF   //TVAR_ash_pGAS[438] //
{0x0F12, 0x00DA},    //010B   //TVAR_ash_pGAS[439] //
{0x0F12, 0x0105},    //0146   //TVAR_ash_pGAS[440] //
{0x0F12, 0x0139},    //0176   //TVAR_ash_pGAS[441] //
{0x0F12, 0x0135},    //0120   //TVAR_ash_pGAS[442] //
{0x0F12, 0x00FC},    //00EC   //TVAR_ash_pGAS[443] //
{0x0F12, 0x00C8},    //00BA   //TVAR_ash_pGAS[444] //
{0x0F12, 0x00A0},    //0093   //TVAR_ash_pGAS[445] //
{0x0F12, 0x0084},    //007A   //TVAR_ash_pGAS[446] //
{0x0F12, 0x0070},    //006C   //TVAR_ash_pGAS[447] //
{0x0F12, 0x0067},    //0069   //TVAR_ash_pGAS[448] //
{0x0F12, 0x0069},    //0073   //TVAR_ash_pGAS[449] //
{0x0F12, 0x0075},    //008B   //TVAR_ash_pGAS[450] //
{0x0F12, 0x008D},    //00AD   //TVAR_ash_pGAS[451] //
{0x0F12, 0x00AA},    //00DD   //TVAR_ash_pGAS[452] //
{0x0F12, 0x00D5},    //0118   //TVAR_ash_pGAS[453] //
{0x0F12, 0x00FD},    //0156   //TVAR_ash_pGAS[454] //
{0x0F12, 0x010B},    //00F0   //TVAR_ash_pGAS[455] //
{0x0F12, 0x00D3},    //00BF   //TVAR_ash_pGAS[456] //
{0x0F12, 0x009E},    //0089   //TVAR_ash_pGAS[457] //
{0x0F12, 0x0075},    //0062   //TVAR_ash_pGAS[458] //
{0x0F12, 0x0057},    //0047   //TVAR_ash_pGAS[459] //
{0x0F12, 0x0045},    //003A   //TVAR_ash_pGAS[460] //
{0x0F12, 0x003D},    //0038   //TVAR_ash_pGAS[461] //
{0x0F12, 0x003E},    //0041   //TVAR_ash_pGAS[462] //
{0x0F12, 0x004C},    //0058   //TVAR_ash_pGAS[463] //
{0x0F12, 0x0064},    //007C   //TVAR_ash_pGAS[464] //
{0x0F12, 0x0085},    //00AC   //TVAR_ash_pGAS[465] //
{0x0F12, 0x00B0},    //00E7   //TVAR_ash_pGAS[466] //
{0x0F12, 0x00D8},    //0123   //TVAR_ash_pGAS[467] //
{0x0F12, 0x00D8},    //00D5   //TVAR_ash_pGAS[468] //
{0x0F12, 0x00A5},    //00A1   //TVAR_ash_pGAS[469] //
{0x0F12, 0x0072},    //006C   //TVAR_ash_pGAS[470] //
{0x0F12, 0x004A},    //0044   //TVAR_ash_pGAS[471] //
{0x0F12, 0x0031},    //0029   //TVAR_ash_pGAS[472] //
{0x0F12, 0x0020},    //001B   //TVAR_ash_pGAS[473] //
{0x0F12, 0x0017},    //0018   //TVAR_ash_pGAS[474] //
{0x0F12, 0x001A},    //0022   //TVAR_ash_pGAS[475] //
{0x0F12, 0x0028},    //0039   //TVAR_ash_pGAS[476] //
{0x0F12, 0x0040},    //005D   //TVAR_ash_pGAS[477] //
{0x0F12, 0x0061},    //008E   //TVAR_ash_pGAS[478] //
{0x0F12, 0x008B},    //00CA   //TVAR_ash_pGAS[479] //
{0x0F12, 0x00B3},    //0105   //TVAR_ash_pGAS[480] //
{0x0F12, 0x00CA},    //00C1   //TVAR_ash_pGAS[481] //
{0x0F12, 0x0096},    //008C   //TVAR_ash_pGAS[482] //
{0x0F12, 0x0063},    //0057	//TVAR_ash_pGAS[483] //
{0x0F12, 0x003A},    //002F	//TVAR_ash_pGAS[484] //
{0x0F12, 0x001F},    //0014	//TVAR_ash_pGAS[485] //
{0x0F12, 0x000D},    //0006	//TVAR_ash_pGAS[486] //
{0x0F12, 0x0005},    //0003	//TVAR_ash_pGAS[487] //
{0x0F12, 0x0006},    //000B	//TVAR_ash_pGAS[488] //
{0x0F12, 0x0014},    //0022	//TVAR_ash_pGAS[489] //
{0x0F12, 0x002A},    //0046	//TVAR_ash_pGAS[490] //
{0x0F12, 0x004B},    //0076	//TVAR_ash_pGAS[491] //
{0x0F12, 0x0078},    //00B4	//TVAR_ash_pGAS[492] //
{0x0F12, 0x009F},    //00F0	//TVAR_ash_pGAS[493] //
{0x0F12, 0x00C3},    //00C1	//TVAR_ash_pGAS[494] //
{0x0F12, 0x0091},    //008B	//TVAR_ash_pGAS[495] //
{0x0F12, 0x005D},    //0055	//TVAR_ash_pGAS[496] //
{0x0F12, 0x0035},    //002C	//TVAR_ash_pGAS[497] //
{0x0F12, 0x0018},    //0011	//TVAR_ash_pGAS[498] //
{0x0F12, 0x0008},    //0003	//TVAR_ash_pGAS[499] //
{0x0F12, 0x0000},    //0000	//TVAR_ash_pGAS[500] //
{0x0F12, 0x0002},    //0007	//TVAR_ash_pGAS[501] //
{0x0F12, 0x000C},    //001D	//TVAR_ash_pGAS[502] //
{0x0F12, 0x0020},    //0040	//TVAR_ash_pGAS[503] //
{0x0F12, 0x0041},    //0070	//TVAR_ash_pGAS[504] //
{0x0F12, 0x006E},    //00AF	//TVAR_ash_pGAS[505] //
{0x0F12, 0x0096},    //00EC	//TVAR_ash_pGAS[506] //
{0x0F12, 0x00C8},    //00C6	//TVAR_ash_pGAS[507] //
{0x0F12, 0x0097},    //0092	//TVAR_ash_pGAS[508] //
{0x0F12, 0x0063},    //005D	//TVAR_ash_pGAS[509] //
{0x0F12, 0x003C},    //0035	//TVAR_ash_pGAS[510] //
{0x0F12, 0x001D},    //0019	//TVAR_ash_pGAS[511] //
{0x0F12, 0x000B},    //000A	//TVAR_ash_pGAS[512] //
{0x0F12, 0x0005},    //0006	//TVAR_ash_pGAS[513] //
{0x0F12, 0x0006},    //000E	//TVAR_ash_pGAS[514] //
{0x0F12, 0x000D},    //0024	//TVAR_ash_pGAS[515] //
{0x0F12, 0x0020},    //0046	//TVAR_ash_pGAS[516] //
{0x0F12, 0x0040},    //0074	//TVAR_ash_pGAS[517] //
{0x0F12, 0x006A},    //00B0	//TVAR_ash_pGAS[518] //
{0x0F12, 0x0093},    //00ED	//TVAR_ash_pGAS[519] //
{0x0F12, 0x00E4},    //00E0	//TVAR_ash_pGAS[520] //
{0x0F12, 0x00A9},    //00AA	//TVAR_ash_pGAS[521] //
{0x0F12, 0x0078},    //0078	//TVAR_ash_pGAS[522] //
{0x0F12, 0x004F},    //0050	//TVAR_ash_pGAS[523] //
{0x0F12, 0x002F},    //0034	//TVAR_ash_pGAS[524] //
{0x0F12, 0x001C},    //0024	//TVAR_ash_pGAS[525] //
{0x0F12, 0x0012},    //001F	//TVAR_ash_pGAS[526] //
{0x0F12, 0x0012},    //0026	//TVAR_ash_pGAS[527] //
{0x0F12, 0x001B},    //003A	//TVAR_ash_pGAS[528] //
{0x0F12, 0x002B},    //005D	//TVAR_ash_pGAS[529] //
{0x0F12, 0x004C},    //008B	//TVAR_ash_pGAS[530] //
{0x0F12, 0x0072},    //00C4	//TVAR_ash_pGAS[531] //
{0x0F12, 0x009B},    //00FE	//TVAR_ash_pGAS[532] //
{0x0F12, 0x00FD},    //00FE	//TVAR_ash_pGAS[533] //
{0x0F12, 0x00C8},    //00CB	//TVAR_ash_pGAS[534] //
{0x0F12, 0x0093},    //0099	//TVAR_ash_pGAS[535] //
{0x0F12, 0x0069},    //0074	//TVAR_ash_pGAS[536] //
{0x0F12, 0x004A},    //005A	//TVAR_ash_pGAS[537] //
{0x0F12, 0x0035},    //004B	//TVAR_ash_pGAS[538] //
{0x0F12, 0x002A},    //0046	//TVAR_ash_pGAS[539] //
{0x0F12, 0x0027},    //004A	//TVAR_ash_pGAS[540] //
{0x0F12, 0x0032},    //005C	//TVAR_ash_pGAS[541] //
{0x0F12, 0x0044},    //007A	//TVAR_ash_pGAS[542] //
{0x0F12, 0x0060},    //00A7	//TVAR_ash_pGAS[543] //
{0x0F12, 0x0085},    //00E0	//TVAR_ash_pGAS[544] //
{0x0F12, 0x00AD},    //0119	//TVAR_ash_pGAS[545] //
{0x0F12, 0x0125},    //0131	//TVAR_ash_pGAS[546] //
{0x0F12, 0x00E9},    //00FD	//TVAR_ash_pGAS[547] //
{0x0F12, 0x00B3},    //00CF	//TVAR_ash_pGAS[548] //
{0x0F12, 0x0090},    //00AC	//TVAR_ash_pGAS[549] //
{0x0F12, 0x0072},    //0092	//TVAR_ash_pGAS[550] //
{0x0F12, 0x0061},    //0084	//TVAR_ash_pGAS[551] //
{0x0F12, 0x0052},    //007F	//TVAR_ash_pGAS[552] //
{0x0F12, 0x0050},    //0085	//TVAR_ash_pGAS[553] //
{0x0F12, 0x0058},    //0094	//TVAR_ash_pGAS[554] //
{0x0F12, 0x006A},    //00AE	//TVAR_ash_pGAS[555] //
{0x0F12, 0x0082},    //00CF	//TVAR_ash_pGAS[556] //
{0x0F12, 0x00A5},    //0107	//TVAR_ash_pGAS[557] //
{0x0F12, 0x00CF},    //0148	//TVAR_ash_pGAS[558] //
{0x0F12, 0x013D},    //015F	//TVAR_ash_pGAS[559] //
{0x0F12, 0x0107},    //012F	//TVAR_ash_pGAS[560] //
{0x0F12, 0x00D8},    //0102	//TVAR_ash_pGAS[561] //
{0x0F12, 0x00BC},    //00E3	//TVAR_ash_pGAS[562] //
{0x0F12, 0x00A1},    //00CA	//TVAR_ash_pGAS[563] //
{0x0F12, 0x0090},    //00BD	//TVAR_ash_pGAS[564] //
{0x0F12, 0x0083},    //00B8	//TVAR_ash_pGAS[565] //
{0x0F12, 0x007E},    //00BC	//TVAR_ash_pGAS[566] //
{0x0F12, 0x0081},    //00CB	//TVAR_ash_pGAS[567] //
{0x0F12, 0x0093},    //00E4	//TVAR_ash_pGAS[568] //
{0x0F12, 0x00A6},    //0104	//TVAR_ash_pGAS[569] //
{0x0F12, 0x00CB},    //012E	//TVAR_ash_pGAS[570] //
{0x0F12, 0x00F1},    //0148	//TVAR_ash_pGAS[571] //
...
{0x0F12, 0x03C8},		//03C8	//03C9	//awbb_IndoorGrZones_m_BGrid[0] //    
{0x0F12, 0x03DE},		//03DE	//03DE	//awbb_IndoorGrZones_m_BGrid[1] // 
{0x0F12, 0x0372},		//0372	//0372	//awbb_IndoorGrZones_m_BGrid[2] // 
{0x0F12, 0x03EA},		//03EA	//03EA	//awbb_IndoorGrZones_m_BGrid[3] // 
{0x0F12, 0x0336},		//0336	//0336	//awbb_IndoorGrZones_m_BGrid[4] // 
{0x0F12, 0x03DE},		//03DE	//03DE	//awbb_IndoorGrZones_m_BGrid[5] // 
{0x0F12, 0x0302},		//0302	//0302	//awbb_IndoorGrZones_m_BGrid[6] // 
{0x0F12, 0x03A2},		//03A2	//03A2	//awbb_IndoorGrZones_m_BGrid[7] // 
{0x0F12, 0x02C8},		//02C8	//02c8	//awbb_IndoorGrZones_m_BGrid[8] // 
{0x0F12, 0x036C},		//0368	//0368	//awbb_IndoorGrZones_m_BGrid[9] // 
{0x0F12, 0x0292},		//0292	//0292	//awbb_IndoorGrZones_m_BGrid[10] //
...
{0x0F12, 0x0246},		//0246	//023A	//awbb_IndoorGrZones_m_BGrid[16] //
{0x0F12, 0x02D6},		//02C0	//02A2	//awbb_IndoorGrZones_m_BGrid[17] //
{0x0F12, 0x0232},		//0232	//0228	//awbb_IndoorGrZones_m_BGrid[18] //
{0x0F12, 0x02B6},		//029E	//0298	//awbb_IndoorGrZones_m_BGrid[19] //
{0x0F12, 0x021E},		//021E	//0210	//awbb_IndoorGrZones_m_BGrid[20] //
{0x0F12, 0x0298},		//0288	//029C	//awbb_IndoorGrZones_m_BGrid[21] //
{0x0F12, 0x0208},		//0208	//01FE	//awbb_IndoorGrZones_m_BGrid[22] //
{0x0F12, 0x027E},		//026C	//0292	//awbb_IndoorGrZones_m_BGrid[23] //
{0x0F12, 0x01EE},		//01EE	//01EE	//awbb_IndoorGrZones_m_BGrid[24] //
{0x0F12, 0x0264},		//025C	//0278	//awbb_IndoorGrZones_m_BGrid[25] //
{0x0F12, 0x01F0},		//01F0	//01F2	//awbb_IndoorGrZones_m_BGrid[26] //
{0x0F12, 0x0248},		//0248	//0268	//awbb_IndoorGrZones_m_BGrid[27] //
...
{0x0F12, 0xFF9C},	//awbb_GridCorr_R[9] // 
...
{0x002A, 0x33A4},
{0x0F12, 0x0206},    //0163	 //TVAR_wbt_pBaseCcmS[0] //
{0x0F12, 0xFF14},    //FF77   //TVAR_wbt_pBaseCcmS[1] //
{0x0F12, 0xFF82},    //FFBF   //TVAR_wbt_pBaseCcmS[2] //
{0x0F12, 0xFF61},    //FEC0   //TVAR_wbt_pBaseCcmS[3] //
{0x0F12, 0x030B},    //0111   //TVAR_wbt_pBaseCcmS[4] //
{0x0F12, 0xFDF4},    //FEAB   //TVAR_wbt_pBaseCcmS[5] //
{0x0F12, 0xFF98},    //FFA2   //TVAR_wbt_pBaseCcmS[6] //
{0x0F12, 0x0021},    //FFB9   //TVAR_wbt_pBaseCcmS[7] //
{0x0F12, 0x02D9},    //023A   //TVAR_wbt_pBaseCcmS[8] //
{0x0F12, 0x0324},    //014F   //TVAR_wbt_pBaseCcmS[9] //
{0x0F12, 0x0103},    //0096   //TVAR_wbt_pBaseCcmS[10] //
{0x0F12, 0xFDE6},    //FF06   //TVAR_wbt_pBaseCcmS[11] //
{0x0F12, 0x0124},    //01CF   //TVAR_wbt_pBaseCcmS[12] //
{0x0F12, 0xFF30},    //FF54   //TVAR_wbt_pBaseCcmS[13] //
{0x0F12, 0x01E6},    //01CD   //TVAR_wbt_pBaseCcmS[14] //
{0x0F12, 0xFE70},    //FEE7   //TVAR_wbt_pBaseCcmS[15] //
{0x0F12, 0x01F8},    //0106   //TVAR_wbt_pBaseCcmS[16] //
{0x0F12, 0x0145},    //00F3   //TVAR_wbt_pBaseCcmS[17] //

{0x0F12, 0x0206},//0163},   //TVAR_wbt_pBaseCcmS[18] //
{0x0F12, 0xFF14},//FF77},   //TVAR_wbt_pBaseCcmS[19] //
{0x0F12, 0xFF82},//FFBF},   //TVAR_wbt_pBaseCcmS[20] //
{0x0F12, 0xFF61},//FEC0},   //TVAR_wbt_pBaseCcmS[21] //
{0x0F12, 0x030B},//0111},   //TVAR_wbt_pBaseCcmS[22] //
{0x0F12, 0xFDF4},//FEAB},   //TVAR_wbt_pBaseCcmS[23] //
{0x0F12, 0xFF98},//FFA2},   //TVAR_wbt_pBaseCcmS[24] //
{0x0F12, 0x0021},//FFB9},   //TVAR_wbt_pBaseCcmS[25] //
{0x0F12, 0x02D9},//023A},   //TVAR_wbt_pBaseCcmS[26] //
{0x0F12, 0x0324},//014F},   //TVAR_wbt_pBaseCcmS[27] //
{0x0F12, 0x0103},//0096},   //TVAR_wbt_pBaseCcmS[28] //
{0x0F12, 0xFDE6},//FF06},   //TVAR_wbt_pBaseCcmS[29] //
{0x0F12, 0x0124},//01CF},   //TVAR_wbt_pBaseCcmS[30] //
{0x0F12, 0xFF30},//FF54},   //TVAR_wbt_pBaseCcmS[31] //
{0x0F12, 0x01E6},//01CD},   //TVAR_wbt_pBaseCcmS[32] //
{0x0F12, 0xFE70},//FEE7},   //TVAR_wbt_pBaseCcmS[33] //
{0x0F12, 0x01F8},//0106},   //TVAR_wbt_pBaseCcmS[34] //
{0x0F12, 0x0145},//00F3},   //TVAR_wbt_pBaseCcmS[35] //

{0x0F12, 0x01E9},  //0163   //TVAR_wbt_pBaseCcmS[36] //
{0x0F12, 0xFF7D},  //FF77   //TVAR_wbt_pBaseCcmS[37] //
{0x0F12, 0x0012},  //FFBF   //TVAR_wbt_pBaseCcmS[38] //
{0x0F12, 0xFEDA},  //FEC0   //TVAR_wbt_pBaseCcmS[39] //
{0x0F12, 0x00BD},  //0111   //TVAR_wbt_pBaseCcmS[40] //
{0x0F12, 0xFF0F},  //FEAB   //TVAR_wbt_pBaseCcmS[41] //
{0x0F12, 0xFFA4},  //FFA2   //TVAR_wbt_pBaseCcmS[42] //
{0x0F12, 0xFFA2},  //FFB9   //TVAR_wbt_pBaseCcmS[43] //
{0x0F12, 0x0254},  //023A   //TVAR_wbt_pBaseCcmS[44] //
{0x0F12, 0x015C},  //014F   //TVAR_wbt_pBaseCcmS[45] //
{0x0F12, 0x0102},  //0096   //TVAR_wbt_pBaseCcmS[46] //
{0x0F12, 0xFE36},  //FF06   //TVAR_wbt_pBaseCcmS[47] //
{0x0F12, 0x021B},  //01CF   //TVAR_wbt_pBaseCcmS[48] //
{0x0F12, 0xFF4B},  //FF54   //TVAR_wbt_pBaseCcmS[49] //
{0x0F12, 0x01D5},  //01CD   //TVAR_wbt_pBaseCcmS[50] //
{0x0F12, 0xFE5E},  //FEE7   //TVAR_wbt_pBaseCcmS[51] //
{0x0F12, 0x0199},  //0106   //TVAR_wbt_pBaseCcmS[52] //
{0x0F12, 0x0135},  //00F3   //TVAR_wbt_pBaseCcmS[53] //
...
{0x002A, 0x3380}, //12
{0x0F12, 0x019A},   //01A0 //0204  //01FA  //0223   //0223  //01F3  //01F3  //TVAR_wbt_pOutdoorCcm[0] //
{0x0F12, 0xFFCC},   //FFC8 //FF8E  //FF94  //FF7C   //FF7C  //FFA4  //FFA4  //TVAR_wbt_pOutdoorCcm[1] //
{0x0F12, 0xFFFF},   //FFFC //FFD2  //FFD6  //FFC5   //FFC5  //FFE4  //FFE4  //TVAR_wbt_pOutdoorCcm[2] //
{0x0F12, 0xFEB3},   //FEAA //FE3D  //FE3D  //FE3D   //FE3D  //FE3D  //FE23  //TVAR_wbt_pOutdoorCcm[3] //
{0x0F12, 0x00F3},   //0102 //0158  //0158  //0158   //0158  //0158  //017D  //TVAR_wbt_pOutdoorCcm[4] //
{0x0F12, 0xFEF3},   //FEED //FF03  //FF03  //FF03   //FF03  //FF03  //FEF9  //TVAR_wbt_pOutdoorCcm[5] //
{0x0F12, 0xFFD1},     //FF99  //FF99  //FF9F   //FF9F  //FF9F  //FF9F  //TVAR_wbt_pOutdoorCcm[6] //
{0x0F12, 0xFFEC},     //0018  //0018  //0011   //0011  //0011  //0011  //TVAR_wbt_pOutdoorCcm[7] //
{0x0F12, 0x0228},     //0235  //0235  //0237   //0237  //0237  //0237  //TVAR_wbt_pOutdoorCcm[8] //
{0x0F12, 0x012F},     //0101  //0101  //00EB   //00D1  //012A  //0143  //TVAR_wbt_pOutdoorCcm[9] //
{0x0F12, 0x00BE},     //0116  //0116  //012A   //0125  //00CA  //00F6  //TVAR_wbt_pOutdoorCcm[10] //
{0x0F12, 0xFF2A},     //FF00  //FF00  //FF02   //FEF5  //FEF6  //FEB1  //TVAR_wbt_pOutdoorCcm[11] //
{0x0F12, 0x0179},     //018C  //018C  //01C5   //01C5  //01C5  //01C5  //TVAR_wbt_pOutdoorCcm[12] //
{0x0F12, 0xFF61},     //FF66  //FF66  //FF80   //FF80  //FF80  //FF80  //TVAR_wbt_pOutdoorCcm[13] //
{0x0F12, 0x017F},     //0167  //0167  //019D   //019D  //019D  //019D  //TVAR_wbt_pOutdoorCcm[14] //
{0x0F12, 0xFEF4},     //FE7A  //FE7A  //FE7A   //FE7A  //FE7A  //FE7A  //TVAR_wbt_pOutdoorCcm[15] //
{0x0F12, 0x01BE},     //0179  //0179  //0179   //0179  //0179  //0179  //TVAR_wbt_pOutdoorCcm[16] //
{0x0F12, 0x00BB},     //0179  //0179  //0179   //0179  //0179  //0179  //TVAR_wbt_pOutdoorCcm[17] //
...
{0x0F12, 0x0A05},	//700008EE //TVAR_afit_pBaseValS[149] /AFIT8_Demosaicing_iNearGrayDesat[7:0],   AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
...
{0x0F12, 0x0A05},   //05 //0A05	//700009BE //TVAR_afit_pBaseValS[253] /AFIT8_Demosaicing_iNearGrayDesat[7:0],   AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
...
{0x0F12, 0x0A05},   //0A05 //0A05	//70000A8E //TVAR_afit_pBaseValS[357] /AFIT8_Demosaicing_iNearGrayDesat[7:0],   AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
...
{0x0F12, 0x0A05},   //0A05 //0A05	//70000B5E //TVAR_afit_pBaseValS[461] /AFIT8_Demosaicing_iNearGrayDesat[7:0],   AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8] 
...
static struct msm_camera_i2c_reg_conf s5k5caga_recommend_settings2[] ={
//init table 2
...
static struct msm_camera_i2c_reg_conf s5k5caga_recommend_settings3[] ={
//init table 3
...
static struct v4l2_subdev_info s5k5caga_subdev_info[] = {
	{
...
static void s5k5caga_stop_stream(struct msm_sensor_ctrl_t *s_ctrl) {};
static struct msm_camera_i2c_conf_array s5k5caga_init_conf[] = {
	{&s5k5caga_reset_settings[0],
	ARRAY_SIZE(s5k5caga_reset_settings), 100, MSM_CAMERA_I2C_WORD_DATA},
	{&s5k5caga_recommend_settings1[0],
	ARRAY_SIZE(s5k5caga_recommend_settings1), 100, MSM_CAMERA_I2C_WORD_DATA},
	{&s5k5caga_recommend_settings2[0],
	ARRAY_SIZE(s5k5caga_recommend_settings2), 100, MSM_CAMERA_I2C_WORD_DATA},
	{&s5k5caga_recommend_settings3[0],
	ARRAY_SIZE(s5k5caga_recommend_settings3), 1000, MSM_CAMERA_I2C_WORD_DATA},
};

static struct msm_camera_i2c_conf_array s5k5caga_confs[] = {
	
	{&s5k5caga_snap_settings[0],
	ARRAY_SIZE(s5k5caga_snap_settings), 0, MSM_CAMERA_I2C_WORD_DATA},
	{&s5k5caga_prev_settings[0],
	ARRAY_SIZE(s5k5caga_prev_settings), 0, MSM_CAMERA_I2C_WORD_DATA},
};

static struct msm_camera_i2c_reg_conf s5k5caga_exposure[][4] = {
	{
	//@@ +1.7EV
    {0xFCFC, 0xD000},
    {0x0028, 0x7000},
...
static struct msm_camera_i2c_conf_array s5k5caga_exposure_confs[][1] = {
	{{s5k5caga_exposure[0],
		ARRAY_SIZE(s5k5caga_exposure[0]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_exposure[1],
		ARRAY_SIZE(s5k5caga_exposure[1]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_exposure[2],
		ARRAY_SIZE(s5k5caga_exposure[2]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_exposure[3],
		ARRAY_SIZE(s5k5caga_exposure[3]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_exposure[4],
		ARRAY_SIZE(s5k5caga_exposure[4]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	
};

static int s5k5caga_exposure_enum_map[] = {
...
static struct msm_camera_i2c_enum_conf_array s5k5caga_exposure_enum_confs = {
	.conf = &s5k5caga_exposure_confs[0][0],
	.conf_enum = s5k5caga_exposure_enum_map,
	.num_enum = ARRAY_SIZE(s5k5caga_exposure_enum_map),
	.num_index = ARRAY_SIZE(s5k5caga_exposure_confs),
	.num_conf = ARRAY_SIZE(s5k5caga_exposure_confs[0]),
	.data_type = MSM_CAMERA_I2C_WORD_DATA,
};
#if 0
static struct msm_camera_i2c_reg_conf s5k5caga_wb[][11] = {
...
static struct msm_camera_i2c_conf_array s5k5caga_wb_confs[][1] = {
	{{s5k5caga_wb[0],
		ARRAY_SIZE(s5k5caga_wb[0]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_wb[1],
		ARRAY_SIZE(s5k5caga_wb[1]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_wb[2],
		ARRAY_SIZE(s5k5caga_wb[2]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_wb[3],
		ARRAY_SIZE(s5k5caga_wb[3]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_wb[4],
		ARRAY_SIZE(s5k5caga_wb[4]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_wb[5],
		ARRAY_SIZE(s5k5caga_wb[5]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_wb[6],
		ARRAY_SIZE(s5k5caga_wb[6]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_wb[7],
		ARRAY_SIZE(s5k5caga_wb[7]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_wb[8],
		ARRAY_SIZE(s5k5caga_wb[8]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_wb[9],
		ARRAY_SIZE(s5k5caga_wb[9]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	
};

static int s5k5caga_wb_enum_map[] = {
...
static struct msm_camera_i2c_enum_conf_array s5k5caga_wb_enum_confs = {
	.conf = &s5k5caga_wb_confs[0][0],
	.conf_enum = s5k5caga_wb_enum_map,
	.num_enum = ARRAY_SIZE(s5k5caga_wb_enum_map),
	.num_index = ARRAY_SIZE(s5k5caga_wb_confs),
	.num_conf = ARRAY_SIZE(s5k5caga_wb_confs[0]),
	.data_type = MSM_CAMERA_I2C_WORD_DATA,
};
#endif
static struct msm_camera_i2c_reg_conf s5k5caga_brightness[][5] = {
	{
	//Brightness -3
    {0xFCFC, 0xD000},
    {0x0028, 0x7000},
...
static struct msm_camera_i2c_conf_array s5k5caga_brightness_confs[][1] = {
	{{s5k5caga_brightness[0],
		ARRAY_SIZE(s5k5caga_brightness[0]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_brightness[1],
		ARRAY_SIZE(s5k5caga_brightness[1]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_brightness[2],
		ARRAY_SIZE(s5k5caga_brightness[2]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_brightness[3],
		ARRAY_SIZE(s5k5caga_brightness[3]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_brightness[4],
		ARRAY_SIZE(s5k5caga_brightness[4]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_brightness[5],
		ARRAY_SIZE(s5k5caga_brightness[5]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	{{s5k5caga_brightness[6],
		ARRAY_SIZE(s5k5caga_brightness[6]), 0, MSM_CAMERA_I2C_WORD_DATA},
	},
	
};

static int s5k5caga_brightness_enum_map[] = {
...
static struct msm_camera_i2c_enum_conf_array s5k5caga_brightness_enum_confs = {
	.conf = &s5k5caga_brightness_confs[0][0],
	.conf_enum = s5k5caga_brightness_enum_map,
	.num_enum = ARRAY_SIZE(s5k5caga_brightness_enum_map),
	.num_index = ARRAY_SIZE(s5k5caga_brightness_confs),
	.num_conf = ARRAY_SIZE(s5k5caga_brightness_confs[0]),
	.data_type = MSM_CAMERA_I2C_WORD_DATA,
};

struct msm_sensor_v4l2_ctrl_info_t s5k5caga_v4l2_ctrl_info[] = {

	{
		...
		.step = 1,
		.enum_cfg_settings = &s5k5caga_exposure_enum_confs,
...
#if 0
	{
		...
		.max = MSM_V4L2_WB_OFF,
		.step = 1,
		.enum_cfg_settings = &s5k5caga_wb_enum_confs,
		.s_v4l2_ctrl = msm_sensor_s_ctrl_by_enum,
	},
#endif
	{
		...
		.step = 1,
		.enum_cfg_settings = &s5k5caga_brightness_enum_confs,
		.s_v4l2_ctrl = msm_sensor_s_ctrl_by_enum,
	},
...
static struct msm_sensor_output_info_t s5k5caga_dimensions[] = {
	{
		.x_output = 0x800,
		.y_output = 0x600,
...
static struct msm_camera_csid_vc_cfg s5k5caga_cid_cfg[] = {
	{0, CSI_YUV422_8, CSI_DECODE_8BIT},
	{1, CSI_EMBED_DATA, CSI_DECODE_8BIT},
};

static struct msm_camera_csi2_params s5k5caga_csi_params = {
	.csid_params = {
		.lane_assign = 0xe4,
		.lane_cnt = 1,
		.lut_params = {
			.num_cid = 2,
			.vc_cfg = s5k5caga_cid_cfg,
		},
	},
	.csiphy_params = {
		.lane_cnt = 1,
...
static struct msm_camera_csi2_params *s5k5caga_csi_params_array[] = {
	&s5k5caga_csi_params,
	&s5k5caga_csi_params,
};

#if 0
static struct msm_sensor_output_reg_addr_t s5k5caga_reg_addr = {
	.x_output = 0x3808,
	.y_output = 0x380A,
...
static struct msm_sensor_id_info_t s5k5caga_id_info = {
...
int32_t msm_s5k5caga_sensor_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
	uint16_t chipid = 0;
	rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x002C, 0x0000,
			MSM_CAMERA_I2C_WORD_DATA);
	if (rc < 0) {
	pr_err("%s: i2c write failed\n", __func__);
	}
	rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x002E, 0x0040,
			MSM_CAMERA_I2C_WORD_DATA);
	if (rc < 0) {
	pr_err("%s: i2c write failed\n", __func__);
	}
...
static const struct i2c_device_id s5k5caga_i2c_id[] = {
	{SENSOR_NAME, (kernel_ulong_t)&s5k5caga_s_ctrl},
	{ }
};
int32_t msm_s5k5caga_sensor_mode_init(struct msm_sensor_ctrl_t *s_ctrl,
...
int32_t msm_s5k5caga_sensor_i2c_probe(struct i2c_client *client,
	const struct i2c_device_id *id)
{
	...
	rc=msm_camera_power_on(&s_ctrl->sensor_i2c_client->client->dev,s_ctrl->sensordata,s_ctrl->reg_ptr);
	...
	rc = msm_s5k5caga_sensor_match_id(s_ctrl);
	if (rc < 0)
		goto probe_fail;
...
static struct i2c_driver s5k5caga_i2c_driver = {
	...
	.probe  = msm_s5k5caga_sensor_i2c_probe,
	.driver = {
		.name = SENSOR_NAME,
	},
};

static struct msm_camera_i2c_client s5k5caga_sensor_i2c_client = {
	.addr_type = MSM_CAMERA_I2C_WORD_ADDR,
};


int32_t msm_s5k5caga_sensor_power_up(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
	...
	rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,0x0F12, 0x0003,	MSM_CAMERA_I2C_WORD_DATA);
	if (rc < 0) {
	pr_err("%s: i2c write failed\n", __func__);
	return rc;
	}
...
int32_t msm_s5k5caga_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{	
	int32_t rc = 0;
	pr_err("%s\n", __func__);
...
int32_t msm_s5k5caga_sensor_write_res_settings(struct msm_sensor_ctrl_t *s_ctrl,
	uint16_t res)
{
	int32_t rc;
	...
	if (rc < 0){
		pr_err("%s  msm_sensor_write_conf_array[%d]  failed",__func__,res);
		return rc;
	}
	return rc;
}
int32_t msm_s5k5caga_sensor_setting(struct msm_sensor_ctrl_t *s_ctrl,
			int update_type, int res)
{
	...
	if (update_type == MSM_SENSOR_REG_INIT) {
		...
		rc=msm_camera_i2c_write(s_ctrl->sensor_i2c_client,
			REG_S5K5CAGX_MCNEX_QTECH_STANDBY_CONTROL, 
			0x0028,
			MSM_CAMERA_I2C_WORD_DATA);
		if (rc < 0) {
		pr_err("%s: i2c write failed\n", __func__);
...
//		if (s_ctrl->curr_csi_params != s_ctrl->csi_params[res]) {
	...
	//	}
		...
		rc=msm_s5k5caga_sensor_write_res_settings(s_ctrl, res);
		if (rc < 0) {
...
static struct v4l2_subdev_core_ops s5k5caga_subdev_core_ops = {
	.s_ctrl = msm_sensor_v4l2_s_ctrl,
	.queryctrl = msm_sensor_v4l2_query_ctrl,
	.ioctl = msm_sensor_subdev_ioctl,
	.s_power = msm_sensor_power,
};
static struct v4l2_subdev_video_ops s5k5caga_subdev_video_ops = {
	.enum_mbus_fmt = msm_sensor_v4l2_enum_fmt,
};

static struct v4l2_subdev_ops s5k5caga_subdev_ops = {
	.core = &s5k5caga_subdev_core_ops,
	.video  = &s5k5caga_subdev_video_ops,
};

static struct msm_sensor_fn_t s5k5caga_func_tbl = {
	.sensor_start_stream = msm_sensor_start_stream,
	.sensor_stop_stream = s5k5caga_stop_stream,
	.sensor_setting = msm_s5k5caga_sensor_setting,
	.sensor_set_sensor_mode = msm_sensor_set_sensor_mode,
	.sensor_mode_init = msm_s5k5caga_sensor_mode_init,
	.sensor_get_output_info = msm_sensor_get_output_info,
	.sensor_config = msm_sensor_config,
	.sensor_power_up = msm_s5k5caga_sensor_power_up,
	.sensor_power_down = msm_s5k5caga_sensor_power_down,
};

static struct msm_sensor_reg_t s5k5caga_regs = {
	.default_data_type = MSM_CAMERA_I2C_WORD_DATA,
	.start_stream_conf = s5k5caga_prev_settings,
	.start_stream_conf_size = ARRAY_SIZE(s5k5caga_prev_settings),
	.init_settings = &s5k5caga_init_conf[0],
	.init_size = ARRAY_SIZE(s5k5caga_init_conf),
	.mode_settings = &s5k5caga_confs[0],
	.output_settings = &s5k5caga_dimensions[0],
	.num_conf = ARRAY_SIZE(s5k5caga_confs),
};

static struct msm_sensor_ctrl_t s5k5caga_s_ctrl = {
	.msm_sensor_reg = &s5k5caga_regs,
	.msm_sensor_v4l2_ctrl_info = s5k5caga_v4l2_ctrl_info,
	.num_v4l2_ctrl = ARRAY_SIZE(s5k5caga_v4l2_ctrl_info),
	.sensor_i2c_client = &s5k5caga_sensor_i2c_client,
	.sensor_i2c_addr = 0x5A,
	//.sensor_output_reg_addr = &s5k5caga_reg_addr,
	.sensor_id_info = &s5k5caga_id_info,
	.cam_mode = MSM_SENSOR_MODE_INVALID,
	.csi_params = &s5k5caga_csi_params_array[0],
	.msm_sensor_mutex = &s5k5caga_mut,
	.sensor_i2c_driver = &s5k5caga_i2c_driver,
	.sensor_v4l2_subdev_info = s5k5caga_subdev_info,
	.sensor_v4l2_subdev_info_size = ARRAY_SIZE(s5k5caga_subdev_info),
	.sensor_v4l2_subdev_ops = &s5k5caga_subdev_ops,
	.func_tbl = &s5k5caga_func_tbl,
};
