...
#include "msm_csid.h"
#include "msm.h"
extern int camera_is_working; // by lijing for can not connect 20121024
...
static int msm_csid_init(struct v4l2_subdev *sd, uint32_t *csid_version)
{
	...
	camera_is_working=1;// by lijing for can not connect 20121024
...
static int msm_csid_release(struct v4l2_subdev *sd)
{
	...
	camera_is_working=0;// by lijing for can not connect 20121024
