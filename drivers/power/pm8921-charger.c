...
#define ZTE_CONFIG_NO_SLEEP_WHEN_CHG_FULLED
...
#ifdef ZTE_CONFIG_NO_SLEEP_WHEN_CHG_FULLED
      struct wake_lock charger_fulled_lock;
#endif
...
#ifdef ZTE_CONFIG_NO_SLEEP_WHEN_CHG_FULLED
             wake_lock(&chip->charger_fulled_lock);
#endif
	} else {
...
#ifdef ZTE_CONFIG_NO_SLEEP_WHEN_CHG_FULLED
             wake_unlock(&chip->charger_fulled_lock);
#endif		
	}
